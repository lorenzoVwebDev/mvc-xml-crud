            ...
            <form id="update-appointment-list">
                <fieldset>
                    <div class="form-floating mb-3">
                      <input class="form-control rounded-3" type="text" name="title" id="title" form="appointment-list" value="appointment" required/>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" name="duedate" id="duedate" form="appointment-list" min="${dayjs().format('YYYY-MM-DD')}"value="${dayjs().format('YYYY-MM-DD')}"/>
                    </div>
                    <div class="mb-3">
